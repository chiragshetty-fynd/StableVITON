...
class StableVITON(UNetModel):
    def __init__(
        ...
        **kwargs,
        ...
        self.encode_output_chs = [320, 320, 640, 640, 640, 1280, 1280, 1280, 1280]

        self.encode_output_chs2 = [320, 320, 320, 320, 640, 640, 640, 1280, 1280]
...
class NoZeroConvControlNet(nn.Module):
    def __init__(
        ...
        if num_attention_blocks is not None:
            ...
            print(
                f"Constructor of UNetModel received um_attention_blocks={num_attention_blocks}. "
