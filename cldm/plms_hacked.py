...
class PLMSSampler(object):
    ...
    def sample(
        ...
        **kwargs,
        ...
        samples, intermediates, cond_output_dict = self.plms_sampling(
            conditioning,
            size,
            callback=callback,
    ...
    def undo(self, x_t, t):
        ...
        x_t_forward = torch.sqrt(1 - beta) * x_t + torch.sqrt(beta) * torch.randn_like(
            x_t
        )
        return x_t_forward
    ...
    def p_sample_plms(
        ...
        def get_model_output(x, t):
            if (
                ...
                model_uncond, _ = self.model.apply_model(
                ...
                e_t = model_uncond + unconditional_guidance_scale * (
