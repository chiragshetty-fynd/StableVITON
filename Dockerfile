ARG base=nvidia/cuda:11.0.3-cudnn8-devel-ubuntu20.04
...
RUN TORCH_CUDA_ARCH_LIST=8.0 pip install 'git+https://github.com/facebookresearch/detectron2.git'
RUN pip install "detectron2-densepose @ git+https://github.com/facebookresearch/detectron2.git#subdirectory=projects/DensePose"
